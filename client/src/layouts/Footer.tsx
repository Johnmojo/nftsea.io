...
const Footer = () => {
  return (
    <footer>
      <div className="z-50 hidden w-full px-8 xl:px-24 pt-8 transition-all duration-300 ease-out sm:block">
      ...
      <div className="z-50 block w-full px-4 pt-8 transition-all duration-300 ease-out sm:hidden">
        <div className="flex flex-col mx-auto items-center justify-between max-w-screen-xl space-y-16">
          <div className="flex gap-16 flex-col xl:flex-row w-full">
            <div className="flex flex-col xl:w-2/5 space-y-9 w-full">
              <div className="space-y-3">
